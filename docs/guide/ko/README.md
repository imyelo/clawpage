...
> **⚠️ 병합 전 확인:** AI 자동 편집은 100% 신뢰할 수 없습니다. PR에서 생성된 YAML 파일을 열어 누락된 민감한 내용을 `[REDACTED]`로 직접 교체하세요. 자세한 내용은 [민감한 정보 보호 방법](https://chats-share.yelo.ooo/share/how-to-protect-sensitive-info)을 참조하세요.
...
| `template.options.promo.enabled` | boolean | 홈페이지에 홍보 블록을 표시하여 openclaw-chats-share 알리기 | `false` |
