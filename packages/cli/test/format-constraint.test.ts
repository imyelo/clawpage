...
describe('ConstraintValidator', () => {
  ...
  it('should extend constraint with custom fields', () => {
    ...
    expect(extended.metadata).toHaveLength(13)
    expect(extended.metadata[12].key).toBe('customField')
  })
})
...
describe('createConstraint', () => {
  it('should create constraint with defaults', () => {
    ...
    expect(constraint.metadata).toHaveLength(12)
  })
  ...
  it('should allow custom override', () => {
    ...
    expect(constraint.metadata).toHaveLength(13) // 12 default + 1 custom
  })
})
